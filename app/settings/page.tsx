            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="emailAddress"
                        id="emailAddress"
                        placeholder="laura@hozon.io"
                        defaultValue="laura@hozon.io"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end gap-4.5 mt-16">
                    <button
                    ...
                    <div className="w-full">
                      ...
                      <div className="relative">
                        <input
                          ...
                          name="bankIBAN"
                          id="bankIBAN"
                          placeholder="GB29 MYBK 6016 1331 9268 11"
                          defaultValue="GB29 MYBK 6016 1331 9268 11"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="bankSWIFT"
                        id="bankSWIFT"
                        placeholder="UUCRGBMMXXX"
                        defaultValue="UUCRGBMMXXX"
                      />
                    </div>
                  </div>
                  <div className="flex justify-end gap-4.5 mt-16">
                ...
                <form action="#">
                  <div className="mb-4 flex items-center gap-3">
                    <div className="h-14 w-14 rounded-full">
                      <Image
                        src={"https://avatars.dicebear.com/v2/avataaars/ea96385aad5f75a49317f08c8fa0662e.svg"}
                        width={55}
                        height={55}
                        alt="User"
                      />
